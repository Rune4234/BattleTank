...
private:
	...
	float CrosshairXLocation = 0.5f;	// Proportional location of crosshair reticule in the X direction (50%, 33%, etc)

	UPROPERTY(EditAnywhere)
	float CrosshairYLocation = 0.33f;	// Proportional location of crosshair reticule in the Y direction (50%, 33%, etc)
